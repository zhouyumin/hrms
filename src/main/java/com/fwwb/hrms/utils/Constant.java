...
/**
 * @Author: 周余民
 * @Date: Created in 10:41 2021/1/26
 * 常量
 */
public class Constant {
    ...
    public static final String AUTHOR_EMPLOYEE="/author_employee";
    ...
    public static final String DEL_AUTHORIZATION="/del_authorization";
}
